...
NSString *const MJRefreshHeaderStateRefreshingText = @"正在刷新数据...";

NSString *const MJRefreshFooterStateIdleText = @"暂无数据";
NSString *const MJRefreshFooterStateRefreshingText = @"正在加载数据...";
NSString *const MJRefreshFooterStateNoMoreDataText = @"数据加载完毕";